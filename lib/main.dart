              ...
              Expanded(
                ...
                child: FlatButton(
                  onPressed: () {
                    ...
                    setState(() {
                      storyNumber = sb.nextStory(choiceNumber: 1);
                    });
                  },
                  color: Colors.red,
                  child: Text(
                ...
                child: Visibility(
                  ...
                  child: FlatButton(
                    onPressed: () {
                      ...
                      setState(() {
                        storyNumber = sb.nextStory(choiceNumber: 2);
                      });
                    },
                    color: Colors.blue,
                    child: Text(
...
//TODO: Step 24 - Run the app and try to figure out what code you need to add to this file
